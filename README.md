...
1. **Data** - pengumpulan, pembersihan, dan integrasi data didokumentasikan dalam notebook di folder `data/` (Data Collection -> Cleaning -> Integration -> Feature Engineering), bersama dataset hasil olahannya.
...
> Dataset & proses wrangling lengkap (notebook + CSV): lihat folder `data/`.
